...
demangles!(_ZUlT_E_, "{lambda(auto:1)#1}");
demangles!(_ZUlT0_E_, "{lambda(auto:2)#1}");
demangles!(_ZUlTyT_E_, "{lambda<typename $T>(auto:1)#1}");
demangles!(_ZUlTnivE_, "{lambda<int>()#1}");
demangles!(_ZUlTpTyvE_, "{lambda<typename $T>()#1}");
